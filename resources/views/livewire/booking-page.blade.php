<div class="max-w-xl mx-auto py-10 px-6 bg-white rounded shadow dark:bg-gray-900 text-white ">
    ...
    <div class="mb-4 text-white">
        ...
        <input type="date" wire:model.defer="tanggal_booking" class="w-full border rounded px-3 py-2 text-white">
    ...
    <div class="mb-4 text-white">
        ...
        <select wire:model.defer="jam_main" class="w-full border rounded px-3 py-2 ">
    ...
    <div class="mb-4">
        ...
        <select wire:model.defer="jenis_pembayaran" class="w-full border rounded px-3 py-2 text-white">
